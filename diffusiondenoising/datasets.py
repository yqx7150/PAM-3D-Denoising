...
class GetMRI(Dataset):
    ...
    def __getitem__(self,index):
        siat_512_input = cv2.imread(self.data_names[index],0)
        siat_input = siat_512_input/ 255.   # float64
        #siat_input=siat_input.transpose(2,0,1)
        #print(siat_input.shape)
...
def get_dataset(config, uniform_dequantization=False, evaluation=False):
  ...
  dataset = GetMRI(root= "/home/liuqg/wgj/diffusiondenoising/train/img")
  test_dataset = GetMRI(root= "/home/liuqg/wgj/diffusiondenoising/train/img")
